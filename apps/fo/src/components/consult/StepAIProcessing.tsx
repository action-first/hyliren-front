...
function buildBudget(range: BudgetRange | null): { budgetMin?: number; budgetMax?: number } {
  switch (range) {
    case 'under100':  return { budgetMin: 0,         budgetMax: 1_000_000  };
    case '100to300':  return { budgetMin: 1_000_000, budgetMax: 3_000_000  };
    case '300to500':  return { budgetMin: 3_000_000, budgetMax: 5_000_000  };
    case 'over500':   return { budgetMin: 5_000_000 };
    default:          return {};
  }
}
